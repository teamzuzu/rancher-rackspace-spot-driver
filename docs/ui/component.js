 ...
 * - Uses Ember.HTMLBars.template() (available in production builds).
 * - No {{each}} → no -track-array helper dependency.
 * - Buttons use onclick={{action}} (attr/helper) not {{action}} (modifier).
 */
